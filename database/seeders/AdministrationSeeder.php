...
class AdministrationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Administration::create([
            ...
            'code' => rand(),
            'birthDate' => '1990-11-20',
            'role' => 'Encargado de bienestar estudiantil'
        ]);
        Administration::create([
            'id' => '7',
            ...
            'code' => rand(),
            'birthDate' => '1990-11-20',
            'role' => 'Encargada de bienestar estudiantil'
        ]);
        Administration::create([
            'id' => '8',
        ...
        Administration::create([
            ...
            'role' => 'Segundo encargado de bienestar estudiantil'
        ]);
        Administration::create([
            'id' => '10',
            ...
            'role' => 'Tercer encargado de bienestar estudiantil'
        ]);
    }
}
