                                        ...
                                        <form onsubmit="disable()" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-primary btn-block"
                                                    id="button-prevent-multiple-submits" type="submit">
                                ...
                                <div class="row">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Estudiantes</td>
                                                        <td>{{ $students }}</td>
                                                        <td><svg width="1em" height="1em" viewBox="0 0 16 16"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $activities }}</td>
                                                        <td><svg width="1em" height="1em" viewBox="0 0 16 16"
                                                                class="bi bi-list-ol" fill="currentColor"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd"
                                    ...
                                    <div class="col-md-12 mt-5">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form onsubmit="disable()" method="POST"
                                                    action="{{ route('module.dates') }}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="inputState">Fecha de inicio</label>
                                                                <input type="date" name="dateStart" id="date"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" name="dateEnd" id="date"
                                                                    class="form-control mb-2" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="course1" class="form-control" name="course_id">
                                    ...
                                    <div class="col-md-12 mt-5">
                                        <div class="card">
                                            <div class="card-header mb-3 text-center bg-white pt-4">
                                                <h3>Consultar por estudiante</h3>
                                            </div>
                                            <div class="card-body">
                                                <form onsubmit="disable()" method="POST"
                                                    action="{{ route('module.datesstudents') }}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
