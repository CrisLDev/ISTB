        ...
        <div class="col-xl-12 mb-3">
            <div class="card">
                <div class="card-header bg-white text-center m-3">
                    ...
                    <h2 class="font-weight-bold mt-3">Información de registro</h2>
                </div>

                <div class="card-body">
                    <div>
                        <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-person-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 class="pt-2 pb-2 pl-5">{{$userInfo->username}}</h5>
                    </div>
                    <div>
                        <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-emoji-sunglasses mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 class="pt-2 pb-2 pl-5">{{$userInfo->name}}</h5>
                    </div>
                    <div>
                        <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-at mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 class="pt-2 pb-2 pl-5">{{$userInfo->email}}</h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-12" style="margin-bottom: 5rem !important;">
                <div class="card pb-3">
                    <div class="card-header bg-white text-center m-3">
                        @if($profileInfo)
                        <a href="{{route('profile.edit', $profileInfo->id)}}" class="editButton">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                              </svg>
                            Editar
                        </a>
                        <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-person-lines-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm7 1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm2 9a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"/>
                        </svg>
                        @endif
                        <h2 class="font-weight-bold mt-3">Información de perfil</h2>
                    </div>    
                    <div class="card-body">
                            @if(!$profileInfo)
                                <div class="d-flex justify-content-center align-items-center">
                                    <h5 class="mr-3">¡No tienes un perfil, Crea uno ahora!</h5>
                                    <a href="{{route('profile.create')}}" class=" btn border hoverEdited">Crear Aqui</a>
                                </div>
                            @else
                            <div>
                                <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-border-style mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h5 class="pt-2 pb-2 pl-5">{{$profileInfo->dni}}</h5>
                            </div>
                            <div>
                                <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-telephone-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M2.267.98a1.636 1.636 0 0 1 2.448.152l1.681 2.162c.309.396.418.913.296 1.4l-.513 2.053a.636.636 0 0 0 .167.604L8.65 9.654a.636.636 0 0 0 .604.167l2.052-.513a1.636 1.636 0 0 1 1.401.296l2.162 1.681c.777.604.849 1.753.153 2.448l-.97.97c-.693.693-1.73.998-2.697.658a17.47 17.47 0 0 1-6.571-4.144A17.47 17.47 0 0 1 .639 4.646c-.34-.967-.035-2.004.658-2.698l.97-.969z"/>
                                    </svg>
                                    Número de teléfono:
                                </h3>
                                <h5 class="pt-2 pb-2 pl-5">{{$profileInfo->telephoneNumber}}</h5>
                            </div>
                            <div>
                                <h3 class="bg-light pt-3 pb-3 p-2 d-flex align-items-center">
                                ...
                                <h5 class="pt-2 pb-2 pl-5">{{$profileInfo->address}}</h5>
                            </div>
                            @endif
                    </div>
                </div>
