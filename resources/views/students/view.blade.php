                        ...
                        <div>
                            ...
                            <div>
                                <form onsubmit="disable()" method="POST"
                                    action="{{ route('assitance.create', $student->id) }}">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="justification"
                                            placeholder="Escriba la justificación" value="{{ old('justification') }}"
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-block"
                                            d="button-prevent-multiple-submits"><span
                                                class="spinner-border spinner-border-sm" id="spinner" role="status"
                                                                ...
                                                                @foreach ($reports as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="text-center">
                                                                                <a class="btn btn-dark"
                                                                                    href="{{ route('reports.editReport', $item->id) }}">editar</a>

                                                                                <form
                                                                                    action="{{ route('reports.destroyReport', $item->id) }}"
                                                                                    method="POST" class="d-inline">
                                                                                    @method('DELETE')
                                                                                    @csrf
