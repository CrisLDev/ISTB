    ...
    <div class="row justify-content-center">
        <div class="col-xl-12 mb-5">
            <div class="card mb-5">
                ...
                <div class="container">
                    <a class="btn btn-block btn-primary" href="{{route('pdfs.administrations')}}">Generar PDF</a>
                </div>
                <div class="card-body">
                            @if (count($administrations) !== 0)
                                ...
                                <div class="col-lg-7 col-md-10 col-sm-12 col-12">
                                    ...
                                    @else
                                        <p><a class="font-weight-bold" href="http://www.jfk.edu.ec/jfk/images/librospdf/J.K._Rowling_-_1Harry_Potter_y_la_Piedra_filosofal.pdf">Curriculum</a></p>
                                    @endif
