                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($courses as $course)
                                          <option value="{{$course->id}}" {{ $course->id == $report->course_id ? 'selected' : '' }}>{{$course->name}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @foreach ($subjects as $subject)
                                          <option value="{{$subject->id}}" {{ $subject->id == $report->subject_id ? 'selected' : '' }}>{{$subject->name}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
